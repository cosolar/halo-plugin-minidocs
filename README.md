...
MiniDocs 是一款专为 Halo 开源建站平台打造的轻量化、高性能知识库插件，主打多知识库独立管理、树形文档架构、原生 Markdown 创作、精细化分类标签与权限管控能力。无需复杂部署，即可快速为个人博主、小型团队、工作室搭建专属结构化知识库，完美适配笔记归档、项目文档、教程手册、团队协作资料等各类内容场景，补齐 Halo 平台原生文档管理短板。
